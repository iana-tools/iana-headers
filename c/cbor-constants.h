...
typedef enum {
  ...
  CBOR_TAG_0_STANDARD_DATE_TIME_STRING = 0,
  ...
  CBOR_TAG_25_REFERENCE_THE_NTH_PREVIOUSLY_SEEN_STRING = 25,
  ...
  CBOR_TAG_29_REFERENCE_NTH_MARKED_VALUE = 29,
  ...
  CBOR_TAG_42_IPLD_CONTENT_IDENTIFIER = 42,
  ...
  CBOR_TAG_46_YANG_INSTANCE_IDENTIFIER_DATATYPE = 46,
  // YANG Schema Item iDentifier (sid); see Section 3.2.; Ref: [RFC9254]
  CBOR_TAG_47_YANG_SCHEMA_ITEM_IDENTIFIER = 47,
  ...
  CBOR_TAG_110_RELATIVE_OBJECT_IDENTIFIER = 110,
  // object identifier (BER encoding); Ref: [RFC9090]
  CBOR_TAG_111_OBJECT_IDENTIFIER = 111,
  // object identifier (BER encoding), relative to 1.3.6.1.4.1; Ref: [RFC9090]
  CBOR_TAG_112_OBJECT_IDENTIFIER_RELATIVE_TO_1_3_6_1_4_1 = 112,
  ...
  CBOR_TAG_257_BINARY_MIME_MESSAGE = 257,
  ...
  CBOR_TAG_266_INTERNATIONALIZED_RESOURCE_IDENTIFIER = 266,
  ...
  CBOR_TAG_1010_OBJECT_TYPE_IDENTIFIER = 1010,
  ...
  CBOR_TAG_18556_COSE_ALGORITHM_IDENTIFIER_BASE_HASH_VALUE = 18556,
  ...
  CBOR_TAG_22098_HINT_THAT_IND_AN_ADD_LVL_OF_INDIRECTION = 22098,
  ...
  CBOR_TAG_55800_IND_THAT_FILE_CONTAINS_CBOR_SEQUENCES = 55800,
  // indicates that the file starts with a CBOR-Labeled Non-CBOR Data label.; Ref: [RFC9277]
  CBOR_TAG_55801_IND_THAT_FILE_STARTS_WITH_CBOR_LABELED_NON_CBOR_DATA_LABEL = 55801,
  ...
  CBOR_TAG_60000_TAGGED_CBOR_ARRAY_CONTAINS_ATTEST_EVID_DATA_WITH_AN_INTEL_TEE_QUOTE = 60000,
  // The tagged CBOR array contains attestation evidence data with an Intel TEE report.; Ref: [Shanwei_Cen]
  CBOR_TAG_60001_TAGGED_CBOR_ARRAY_CONTAINS_ATTEST_EVID_DATA_WITH_AN_INTEL_TEE_RPT = 60001,
  // The tagged CBOR array contains attestation evidence data with an Intel SGX report.; Ref: [Shanwei_Cen]
  CBOR_TAG_60002_TAGGED_CBOR_ARRAY_CONTAINS_ATTEST_EVID_DATA_WITH_AN_INTEL_SGX_RPT = 60002,
  ...
  CBOR_TAG_15309736_RAINS_MESSAGE = 15309736,
  // A CBOR encoded Openswan configuration file, as stored on disk forunit test cases.; Ref: [Michael_Richardson][Samir_Hussain]
  CBOR_TAG_1330664270_CBOR_ENCODED_OPENSWAN_CONFIG_FILE_AS_STORED_ON_DISK_FORUNIT_TEST_CASES = 1330664270,
  // Concise Software Identifier (CoSWID); Ref: [RFC9393]
  CBOR_TAG_1398229316_CONCISE_SOFTWARE_IDENTIFIER = 1398229316,
