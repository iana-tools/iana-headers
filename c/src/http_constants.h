...
#define HTTP_FIELD_NAME_ACCEPT_CH "Accept-CH" // Accept-CH; List; permanent; Ref: [RFC 8942, Section 3.1: HTTP Client Hints]
...
#define HTTP_FIELD_NAME_ACCEPT_POST "Accept-Post" // Accept-Post; permanent; Ref: [Linked Data Platform 1.0]
...
#define HTTP_FIELD_NAME_AVAILABLE_DICTIONARY "Available-Dictionary" // Available-Dictionary; permanent; Ref: [RFC-ietf-httpbis-compression-dictionary-19, Section 2.2: Compression Dictionary Transport]
...
#define HTTP_FIELD_NAME_CACHE_STATUS "Cache-Status" // Cache-Status; List; permanent; Ref: [RFC9211: The Cache-Status HTTP Response Header Field]
...
#define HTTP_FIELD_NAME_CDN_CACHE_CONTROL "CDN-Cache-Control" // CDN-Cache-Control; Dictionary; permanent; Ref: [RFC9213: Targeted HTTP Cache Control]
...
#define HTTP_FIELD_NAME_CLIENT_CERT "Client-Cert" // Client-Cert; Item; permanent; Ref: [RFC9440, Section 2: Client-Cert HTTP Header Field]
#define HTTP_FIELD_NAME_CLIENT_CERT_CHAIN "Client-Cert-Chain" // Client-Cert-Chain; List; permanent; Ref: [RFC9440, Section 2: Client-Cert HTTP Header Field]
#define HTTP_FIELD_NAME_CLOSE "Close" // Close; permanent; Ref: [RFC9112, Section 9.6: HTTP/1.1]
#define HTTP_FIELD_NAME_CMCD_OBJECT "CMCD-Object" // CMCD-Object; provisional; Ref: [CTA][CTA-5004 Common Media Client Data]
#define HTTP_FIELD_NAME_CMCD_REQUEST "CMCD-Request" // CMCD-Request; provisional; Ref: [CTA][CTA-5004 Common Media Client Data]
#define HTTP_FIELD_NAME_CMCD_SESSION "CMCD-Session" // CMCD-Session; provisional; Ref: [CTA][CTA-5004 Common Media Client Data]
...
#define HTTP_FIELD_NAME_CONTENT_MD5 "Content-MD5" // Content-MD5; obsoleted; Ref: [RFC 2616, Section 14.15: Hypertext Transfer Protocol -- HTTP/1.1]
...
#define HTTP_FIELD_NAME_COOKIE2 "Cookie2" // Cookie2; obsoleted; Ref: [RFC 2965: HTTP State Management Mechanism]
#define HTTP_FIELD_NAME_CROSS_ORIGIN_EMBEDDER_POLICY "Cross-Origin-Embedder-Policy" // Cross-Origin-Embedder-Policy; Item; permanent; Ref: [HTML]
#define HTTP_FIELD_NAME_CROSS_ORIGIN_EMBEDDER_POLICY_REPORT_ONLY "Cross-Origin-Embedder-Policy-Report-Only" // Cross-Origin-Embedder-Policy-Report-Only; Item; permanent; Ref: [HTML]
#define HTTP_FIELD_NAME_CROSS_ORIGIN_OPENER_POLICY "Cross-Origin-Opener-Policy" // Cross-Origin-Opener-Policy; Item; permanent; Ref: [HTML]
#define HTTP_FIELD_NAME_CROSS_ORIGIN_OPENER_POLICY_REPORT_ONLY "Cross-Origin-Opener-Policy-Report-Only" // Cross-Origin-Opener-Policy-Report-Only; Item; permanent; Ref: [HTML]
...
#define HTTP_FIELD_NAME_CTA_COMMON_ACCESS_TOKEN "CTA-Common-Access-Token" // CTA-Common-Access-Token; provisional; Ref: [CTA][Chris_Lemmons]
#define HTTP_FIELD_NAME_C_EXT "C-Ext" // C-Ext; obsoleted; Ref: [RFC 2774: An HTTP Extension Framework]
#define HTTP_FIELD_NAME_C_MAN "C-Man" // C-Man; obsoleted; Ref: [RFC 2774: An HTTP Extension Framework]
#define HTTP_FIELD_NAME_C_OPT "C-Opt" // C-Opt; obsoleted; Ref: [RFC 2774: An HTTP Extension Framework]
#define HTTP_FIELD_NAME_C_PEP "C-PEP" // C-PEP; obsoleted; Ref: [PEP - an Extension Mechanism for HTTP]
#define HTTP_FIELD_NAME_C_PEP_INFO "C-PEP-Info" // C-PEP-Info; deprecated; Ref: [PEP - an Extension Mechanism for HTTP]
...
#define HTTP_FIELD_NAME_EXPECT_CT "Expect-CT" // Expect-CT; deprecated; Ref: [RFC9163: Expect-CT Extension for HTTP]
#define HTTP_FIELD_NAME_EXPIRES "Expires" // Expires; permanent; Ref: [RFC9111, Section 5.3: HTTP Caching]
#define HTTP_FIELD_NAME_EXT "Ext" // Ext; obsoleted; Ref: [RFC 2774: An HTTP Extension Framework]
...
#define HTTP_FIELD_NAME_ISOLATION "Isolation" // Isolation; provisional; Ref: [OData Version 4.01 Part 1: Protocol][OASIS][Chet_Ensign]
...
#define HTTP_FIELD_NAME_LINK_TEMPLATE "Link-Template" // Link-Template; permanent; Ref: [RFC 9652: The Link-Template HTTP Header Field]
...
#define HTTP_FIELD_NAME_MAN "Man" // Man; obsoleted; Ref: [RFC 2774: An HTTP Extension Framework]
...
#define HTTP_FIELD_NAME_ODATA_ENTITYID "OData-EntityId" // OData-EntityId; permanent; Ref: [OData Version 4.01 Part 1: Protocol][OASIS][Chet_Ensign]
#define HTTP_FIELD_NAME_ODATA_ISOLATION "OData-Isolation" // OData-Isolation; permanent; Ref: [OData Version 4.01 Part 1: Protocol][OASIS][Chet_Ensign]
#define HTTP_FIELD_NAME_ODATA_MAXVERSION "OData-MaxVersion" // OData-MaxVersion; permanent; Ref: [OData Version 4.01 Part 1: Protocol][OASIS][Chet_Ensign]
#define HTTP_FIELD_NAME_ODATA_VERSION "OData-Version" // OData-Version; permanent; Ref: [OData Version 4.01 Part 1: Protocol][OASIS][Chet_Ensign]
#define HTTP_FIELD_NAME_OPT "Opt" // Opt; obsoleted; Ref: [RFC 2774: An HTTP Extension Framework]
...
#define HTTP_FIELD_NAME_ORIGIN_AGENT_CLUSTER "Origin-Agent-Cluster" // Origin-Agent-Cluster; Item; permanent; Ref: [HTML]
...
#define HTTP_FIELD_NAME_PRIORITY "Priority" // Priority; Dictionary; permanent; Ref: [RFC9218: Extensible Prioritization Scheme for HTTP]
...
#define HTTP_FIELD_NAME_PROXY_STATUS "Proxy-Status" // Proxy-Status; List; permanent; Ref: [RFC9209: The Proxy-Status HTTP Response Header Field]
...
#define HTTP_FIELD_NAME_REFERRER_POLICY "Referrer-Policy" // Referrer-Policy; permanent; Ref: [Referrer Policy]
#define HTTP_FIELD_NAME_REFRESH "Refresh" // Refresh; permanent; Ref: [HTML]
#define HTTP_FIELD_NAME_REPEATABILITY_CLIENT_ID "Repeatability-Client-ID" // Repeatability-Client-ID; provisional; Ref: [Repeatable Requests Version 1.0][OASIS][Chet_Ensign]
#define HTTP_FIELD_NAME_REPEATABILITY_FIRST_SENT "Repeatability-First-Sent" // Repeatability-First-Sent; provisional; Ref: [Repeatable Requests Version 1.0][OASIS][Chet_Ensign]
#define HTTP_FIELD_NAME_REPEATABILITY_REQUEST_ID "Repeatability-Request-ID" // Repeatability-Request-ID; provisional; Ref: [Repeatable Requests Version 1.0][OASIS][Chet_Ensign]
#define HTTP_FIELD_NAME_REPEATABILITY_RESULT "Repeatability-Result" // Repeatability-Result; provisional; Ref: [Repeatable Requests Version 1.0][OASIS][Chet_Ensign]
...
#define HTTP_FIELD_NAME_SAFE "Safe" // Safe; obsoleted; Ref: [RFC 2310: The Safe Response Header Field]
...
#define HTTP_FIELD_NAME_SEC_FETCH_DEST "Sec-Fetch-Dest" // Sec-Fetch-Dest; Item; Permanent; Ref: [https://www.w3.org/TR/fetch-metadata/#sec-fetch-dest-header]
#define HTTP_FIELD_NAME_SEC_FETCH_MODE "Sec-Fetch-Mode" // Sec-Fetch-Mode; Item; Permanent; Ref: [https://www.w3.org/TR/fetch-metadata/#sec-fetch-mode-header]
#define HTTP_FIELD_NAME_SEC_FETCH_SITE "Sec-Fetch-Site" // Sec-Fetch-Site; Item; Permanent; Ref: [https://www.w3.org/TR/fetch-metadata/#sec-fetch-site-header]
...
#define HTTP_FIELD_NAME_SEC_FETCH_USER "Sec-Fetch-User" // Sec-Fetch-User; Item; Permanent; Ref: [https://www.w3.org/TR/fetch-metadata/#sec-fetch-user-header]
...
#define HTTP_FIELD_NAME_SET_COOKIE2 "Set-Cookie2" // Set-Cookie2; obsoleted; Ref: [RFC 2965: HTTP State Management Mechanism]
...
#define HTTP_FIELD_NAME_TIMING_ALLOW_ORIGIN "Timing-Allow-Origin" // Timing-Allow-Origin; provisional; Ref: [Resource Timing Level 1]
...
#define HTTP_FIELD_NAME_USE_AS_DICTIONARY "Use-As-Dictionary" // Use-As-Dictionary; permanent; Ref: [RFC-ietf-httpbis-compression-dictionary-19, Section 2.1: Compression Dictionary Transport]
...
#define HTTP_FIELD_NAME_WANT_DIGEST "Want-Digest" // Want-Digest; obsoleted; Ref: [RFC 3230: Instance Digests in HTTP]
...
#define HTTP_FIELD_NAME_WILDCARD "*" // *; permanent; Ref: [RFC9110, Section 12.5.5: HTTP Semantics]
