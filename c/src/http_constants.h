...
X(HTTP_FIELD_NAME_ACCEPT, "Accept") /* Accept; permanent; Ref: [RFC9110, Section 12.5.1: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_ACCEPT_CHARSET, "Accept-Charset") /* Accept-Charset; deprecated; Ref: [RFC9110, Section 12.5.2: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_ACCEPT_ENCODING, "Accept-Encoding") /* Accept-Encoding; permanent; Ref: [RFC9110, Section 12.5.3: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_ACCEPT_LANGUAGE, "Accept-Language") /* Accept-Language; permanent; Ref: [RFC9110, Section 12.5.4: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_ACCEPT_RANGES, "Accept-Ranges") /* Accept-Ranges; permanent; Ref: [RFC9110, Section 14.3: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_AGE, "Age") /* Age; permanent; Ref: [RFC9111, Section 5.1: HTTP Caching] */\
X(HTTP_FIELD_NAME_ALLOW, "Allow") /* Allow; permanent; Ref: [RFC9110, Section 10.2.1: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_AUTHENTICATION_INFO, "Authentication-Info") /* Authentication-Info; permanent; Ref: [RFC9110, Section 11.6.3: HTTP Semantics] */\
X(HTTP_FIELD_NAME_AUTHORIZATION, "Authorization") /* Authorization; permanent; Ref: [RFC9110, Section 11.6.2: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_CACHE_CONTROL, "Cache-Control") /* Cache-Control; permanent; Ref: [RFC9111, Section 5.2] */\
X(HTTP_FIELD_NAME_CACHE_STATUS, "Cache-Status") /* Cache-Status; List; permanent; Ref: [RFC9211: The Cache-Status HTTP Response Header Field] */\
...
X(HTTP_FIELD_NAME_CAPSULE_PROTOCOL, "Capsule-Protocol") /* Capsule-Protocol; permanent; Ref: [RFC9297] */\
X(HTTP_FIELD_NAME_CDN_CACHE_CONTROL, "CDN-Cache-Control") /* CDN-Cache-Control; Dictionary; permanent; Ref: [RFC9213: Targeted HTTP Cache Control] */\
...
X(HTTP_FIELD_NAME_CLIENT_CERT, "Client-Cert") /* Client-Cert; Item; permanent; Ref: [RFC9440, Section 2: Client-Cert HTTP Header Field] */\
X(HTTP_FIELD_NAME_CLIENT_CERT_CHAIN, "Client-Cert-Chain") /* Client-Cert-Chain; List; permanent; Ref: [RFC9440, Section 2: Client-Cert HTTP Header Field] */\
X(HTTP_FIELD_NAME_CLOSE, "Close") /* Close; permanent; Ref: [RFC9112, Section 9.6: HTTP/1.1] */\
...
X(HTTP_FIELD_NAME_CONCEALED_AUTH_EXPORT, "Concealed-Auth-Export") /* Concealed-Auth-Export; Item; permanent; Ref: [RFC9729: The Concealed HTTP Authentication Scheme] */\
...
X(HTTP_FIELD_NAME_CONNECTION, "Connection") /* Connection; permanent; Ref: [RFC9110, Section 7.6.1: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_CONTENT_ENCODING, "Content-Encoding") /* Content-Encoding; permanent; Ref: [RFC9110, Section 8.4: HTTP Semantics] */\
X(HTTP_FIELD_NAME_CONTENT_ID, "Content-ID") /* Content-ID; deprecated; Ref: [The HTTP Distribution and Replication Protocol] */\
X(HTTP_FIELD_NAME_CONTENT_LANGUAGE, "Content-Language") /* Content-Language; permanent; Ref: [RFC9110, Section 8.5: HTTP Semantics] */\
X(HTTP_FIELD_NAME_CONTENT_LENGTH, "Content-Length") /* Content-Length; permanent; Ref: [RFC9110, Section 8.6: HTTP Semantics] */\
X(HTTP_FIELD_NAME_CONTENT_LOCATION, "Content-Location") /* Content-Location; permanent; Ref: [RFC9110, Section 8.7: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_CONTENT_RANGE, "Content-Range") /* Content-Range; permanent; Ref: [RFC9110, Section 14.4: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_CONTENT_TYPE, "Content-Type") /* Content-Type; permanent; Ref: [RFC9110, Section 8.3: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_DATE, "Date") /* Date; permanent; Ref: [RFC9110, Section 6.6.1: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_DEPRECATION, "Deprecation") /* Deprecation; Item; permanent; Ref: [RFC9745, Section 2: The Deprecation HTTP Response Header Field] */\
...
X(HTTP_FIELD_NAME_DPOP, "DPoP") /* DPoP; permanent; Ref: [RFC9449: OAuth 2.0 Demonstrating Proof of Possession (DPoP)] */\
X(HTTP_FIELD_NAME_DPOP_NONCE, "DPoP-Nonce") /* DPoP-Nonce; permanent; Ref: [RFC9449: OAuth 2.0 Demonstrating Proof of Possession (DPoP)] */\
...
X(HTTP_FIELD_NAME_ETAG, "ETag") /* ETag; permanent; Ref: [RFC9110, Section 8.8.3: HTTP Semantics] */\
X(HTTP_FIELD_NAME_EXPECT, "Expect") /* Expect; permanent; Ref: [RFC9110, Section 10.1.1: HTTP Semantics] */\
X(HTTP_FIELD_NAME_EXPECT_CT, "Expect-CT") /* Expect-CT; deprecated; Ref: [RFC9163: Expect-CT Extension for HTTP] */\
X(HTTP_FIELD_NAME_EXPIRES, "Expires") /* Expires; permanent; Ref: [RFC9111, Section 5.3: HTTP Caching] */\
...
X(HTTP_FIELD_NAME_FROM, "From") /* From; permanent; Ref: [RFC9110, Section 10.1.2: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_HOST, "Host") /* Host; permanent; Ref: [RFC9110, Section 7.2: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_IF_MATCH, "If-Match") /* If-Match; permanent; Ref: [RFC9110, Section 13.1.1: HTTP Semantics] */\
X(HTTP_FIELD_NAME_IF_MODIFIED_SINCE, "If-Modified-Since") /* If-Modified-Since; permanent; Ref: [RFC9110, Section 13.1.3: HTTP Semantics] */\
X(HTTP_FIELD_NAME_IF_NONE_MATCH, "If-None-Match") /* If-None-Match; permanent; Ref: [RFC9110, Section 13.1.2: HTTP Semantics] */\
X(HTTP_FIELD_NAME_IF_RANGE, "If-Range") /* If-Range; permanent; Ref: [RFC9110, Section 13.1.5: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_IF_UNMODIFIED_SINCE, "If-Unmodified-Since") /* If-Unmodified-Since; permanent; Ref: [RFC9110, Section 13.1.4: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_LAST_MODIFIED, "Last-Modified") /* Last-Modified; permanent; Ref: [RFC9110, Section 8.8.2: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_LOCATION, "Location") /* Location; permanent; Ref: [RFC9110, Section 10.2.2: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_MAX_FORWARDS, "Max-Forwards") /* Max-Forwards; permanent; Ref: [RFC9110, Section 7.6.2: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_MIME_VERSION, "MIME-Version") /* MIME-Version; permanent; Ref: [RFC9112, Appendix B.1: HTTP/1.1] */\
...
X(HTTP_FIELD_NAME_PRAGMA, "Pragma") /* Pragma; deprecated; Ref: [RFC9111, Section 5.4: HTTP Caching] */\
...
X(HTTP_FIELD_NAME_PRIORITY, "Priority") /* Priority; Dictionary; permanent; Ref: [RFC9218: Extensible Prioritization Scheme for HTTP] */\
...
X(HTTP_FIELD_NAME_PROXY_AUTHENTICATE, "Proxy-Authenticate") /* Proxy-Authenticate; permanent; Ref: [RFC9110, Section 11.7.1: HTTP Semantics] */\
X(HTTP_FIELD_NAME_PROXY_AUTHENTICATION_INFO, "Proxy-Authentication-Info") /* Proxy-Authentication-Info; permanent; Ref: [RFC9110, Section 11.7.3: HTTP Semantics] */\
X(HTTP_FIELD_NAME_PROXY_AUTHORIZATION, "Proxy-Authorization") /* Proxy-Authorization; permanent; Ref: [RFC9110, Section 11.7.2: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_PROXY_STATUS, "Proxy-Status") /* Proxy-Status; List; permanent; Ref: [RFC9209: The Proxy-Status HTTP Response Header Field] */\
...
X(HTTP_FIELD_NAME_RANGE, "Range") /* Range; permanent; Ref: [RFC9110, Section 14.2: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_REFERER, "Referer") /* Referer; permanent; Ref: [RFC9110, Section 10.1.3: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_RETRY_AFTER, "Retry-After") /* Retry-After; permanent; Ref: [RFC9110, Section 10.2.3: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_SERVER, "Server") /* Server; permanent; Ref: [RFC9110, Section 10.2.4: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_TE, "TE") /* TE; permanent; Ref: [RFC9110, Section 10.1.4: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_TRAILER, "Trailer") /* Trailer; permanent; Ref: [RFC9110, Section 6.6.2: HTTP Semantics] */\
X(HTTP_FIELD_NAME_TRANSFER_ENCODING, "Transfer-Encoding") /* Transfer-Encoding; permanent; Ref: [RFC9112, Section 6.1: HTTP Semantics] */\
X(HTTP_FIELD_NAME_TTL, "TTL") /* TTL; permanent; Ref: [RFC 8030, Section 5.2: Generic Event Delivery Using HTTP Push] */\
X(HTTP_FIELD_NAME_UPGRADE, "Upgrade") /* Upgrade; permanent; Ref: [RFC9110, Section 7.8: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_USER_AGENT, "User-Agent") /* User-Agent; permanent; Ref: [RFC9110, Section 10.1.5: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_VARY, "Vary") /* Vary; permanent; Ref: [RFC9110, Section 12.5.5: HTTP Semantics] */\
X(HTTP_FIELD_NAME_VIA, "Via") /* Via; permanent; Ref: [RFC9110, Section 7.6.3: HTTP Semantics] */\
...
X(HTTP_FIELD_NAME_WARNING, "Warning") /* Warning; obsoleted; Ref: [RFC9111, Section 5.5: HTTP Caching] */\
X(HTTP_FIELD_NAME_WILDCARD, "*") /* *; permanent; Ref: [RFC9110, Section 12.5.5: HTTP Semantics] */\
X(HTTP_FIELD_NAME_WWW_AUTHENTICATE, "WWW-Authenticate") /* WWW-Authenticate; permanent; Ref: [RFC9110, Section 11.6.1: HTTP Semantics] */\
