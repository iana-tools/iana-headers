...
def iana_coap_content_format_c_header_content(coap_content_content_format, coap_content_content_source_url):
    c_header_content = ""
    c_header_content += spacing_string + f"/* Autogenerated IANA CoAP Content-Formats (Source: {coap_content_content_source_url}) */\n"
