...
def coap_content_formats_existing_header_update(coap_content_content_format, c_typedef_name):
    existing_enum_name = {}
    with open(iana_coap_c_header_file_path, 'r') as file:
        c_code = file.read()
        existing_enum_name = extract_enum_values_from_c_code(c_code, c_typedef_name)
...
def iana_coap_content_format_c_header_content(coap_content_content_format, source_name, source_url):
    c_header_content = ""
    c_header_content += spacing_string + f"/* Autogenerated {source_name} (Source: {source_url}) */\n"
...
def iana_coap_content_format_c_typedef_enum_update(header_file_content: str) -> str:
    ...
    coap_content_content_format = coap_content_formats_existing_header_update(coap_content_content_format, iana_coap_content_format_settings["c_typedef_name"])

    # Generate enumeration header content
    c_header_content = iana_coap_content_format_c_header_content(coap_content_content_format, iana_coap_content_format_settings["name"], iana_coap_content_format_settings["source"])
