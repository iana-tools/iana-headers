...
#define HTTP_FIELD_NAME_ACCEPT_SIGNATURE "Accept-Signature" // Accept-Signature; permanent; Ref: [RFC-ietf-httpbis-message-signatures-19, Section 5.1: HTTP Message Signatures]
...
#define HTTP_FIELD_NAME_CONTENT_DIGEST "Content-Digest" // Content-Digest; permanent; Ref: [RFC-ietf-httpbis-digest-headers-13, Section 2: Digest Fields]
...
#define HTTP_FIELD_NAME_CONTENT_ID "Content-ID" // Content-ID; permanent; Ref: [The HTTP Distribution and Replication Protocol]
...
#define HTTP_FIELD_NAME_DIFFERENTIAL_ID "Differential-ID" // Differential-ID; permanent; Ref: [The HTTP Distribution and Replication Protocol]
#define HTTP_FIELD_NAME_DIGEST "Digest" // Digest; obsoleted; Ref: [RFC 3230: Instance Digests in HTTP][RFC-ietf-httpbis-digest-headers-13, Section 1.3: Digest Fields]
...
#define HTTP_FIELD_NAME_EXPECT_CT "Expect-CT" // Expect-CT; permanent; Ref: [RFC9163: Expect-CT Extension for HTTP]
...
#define HTTP_FIELD_NAME_REPR_DIGEST "Repr-Digest" // Repr-Digest; permanent; Ref: [RFC-ietf-httpbis-digest-headers-13, Section 3: Digest Fields]
...
#define HTTP_FIELD_NAME_SIGNATURE "Signature" // Signature; permanent; Ref: [RFC-ietf-httpbis-message-signatures-19, Section 4.2: HTTP Message Signatures]
#define HTTP_FIELD_NAME_SIGNATURE_INPUT "Signature-Input" // Signature-Input; permanent; Ref: [RFC-ietf-httpbis-message-signatures-19, Section 4.1: HTTP Message Signatures]
...
#define HTTP_FIELD_NAME_SURROGATE_CAPABILITY "Surrogate-Capability" // Surrogate-Capability; permanent; Ref: [Edge Architecture Specification]
#define HTTP_FIELD_NAME_SURROGATE_CONTROL "Surrogate-Control" // Surrogate-Control; permanent; Ref: [Edge Architecture Specification]
...
#define HTTP_FIELD_NAME_WANT_CONTENT_DIGEST "Want-Content-Digest" // Want-Content-Digest; permanent; Ref: [RFC-ietf-httpbis-digest-headers-13, Section 4: Digest Fields]
#define HTTP_FIELD_NAME_WANT_DIGEST "Want-Digest" // Want-Digest; obsoleted; Ref: [RFC 3230: Instance Digests in HTTP][RFC-ietf-httpbis-digest-headers-13, Section 1.3: Digest Fields]
#define HTTP_FIELD_NAME_WANT_REPR_DIGEST "Want-Repr-Digest" // Want-Repr-Digest; permanent; Ref: [RFC-ietf-httpbis-digest-headers-13, Section 4: Digest Fields]
